...
import { AllProductResponse, MessageResponse, NewProductRequest, ProductResponse, categoriesResponse, deleteProductRequest, searchProductsRequest, searchProductsResponse, updateProductRequest } from '../../types/api-types';
